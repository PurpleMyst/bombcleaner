...
const imageForNumber = (n: number): string => {
  switch (n) {
    case 0: return SquareImage.ZERO;
    case 1: return SquareImage.ONE;
    case 2: return SquareImage.TWO;
    case 3: return SquareImage.THREE;
    case 4: return SquareImage.FOUR;
    case 5: return SquareImage.FIVE;
    case 6: return SquareImage.SIX;
    case 7: return SquareImage.SEVEN;
    case 8: return SquareImage.EIGHT;
    default: throw new Error(`Invalid square image number ${n}`);
  }
}
